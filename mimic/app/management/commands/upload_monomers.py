...
from app.parsers import MonomerParser


class Command(BaseCommand):
    help = (
        'Uploads data for Integrin Monomers from an excel sheet. See the '
        'mimicDB docs and MonomerParser docs for more information on the '
    ...
    def _parse_monomers(self, filename):
        ...
        monomer_parser = MonomerParser(filename)
