...
from app.parsers import DimerParser


class Command(BaseCommand):
    help = (
        'Uploads data for Integrin Dimers from an excel sheet. See the '
        'mimicDB docs and DimerParser docs for more information on the '
    ...
    def _parse_monomers(self, filename):
        ...
        monomer_parser = DimerParser(filename)
